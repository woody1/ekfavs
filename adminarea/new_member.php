...
<html lang="en">
  ...
  -->
        ...
        <div class="container pt100">
            ...
            <p>This form creates a new member of household <?= $_POST['household'] ?>.</p>
            ...
            <form id="contact" action="household.php" method="post">
                ...
                <div class="form-group col-md-8 mt20">
                    <input type="hidden" name="nm" value="add">
                    <input type="hidden" name="household" value="<?= $_POST['household']  ?>">
                    <button class="btn btn-secondary" id="submitButton" data-badge="inline" name="button" value="">Cancel</button>
